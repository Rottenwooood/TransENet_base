...
def make_model(args, parent=False):
    return SymUNet_Pretrain_S1_Trans_F1(args)
...
class SymUNet_Pretrain_S1_Trans_F1(nn.Module):
    """
    S1_Trans: 串联架构
    ...
    def __init__(self, args, conv=common.default_conv):
        super(SymUNet_Pretrain_S1_Trans_F1, self).__init__()
...
if __name__ == "__main__":
    ...
    model = SymUNet_Pretrain_S1_Trans_F1(args)
    model.eval()
