#!/bin/bash
# Training script for symunet_pretrain_lsconv_strip (LSConv + Strip hybrid)
...
python metric_scripts/calculate_PSNR_SSIM.py --folder_Gen ../experiment/results/s1_trans_lsconv_strip_46W32/x4 | tail -n 1 >> results.txt
