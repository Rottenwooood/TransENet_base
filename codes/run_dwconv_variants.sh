...
python user/batch_train.py --config user/experiments_config5_02_s1_trans_f1.json
python user/batch_train.py --config user/experiments_config5_02_s1_trans_f2.json
python user/batch_train.py --config user/experiments_config5_02_s1_trans_f3.json
...
python demo_deploy.py --model CSYMUNET_PRETRAIN_S1_Trans_F1     --symunet_pretrain_width 32     --symunet_pretrain_enc_blk_nums 4,6     --symunet_pretrain_dec_blk_nums 6,4     --dataset UCMerced     --scale 4 --pre_train /root/autodl-tmp/TransENet_base/experiment/s1_trans_f1_001_s1_trans_f1_w32/model/model_best.pt --dir_out ../experiment/results/s1_trans_f1_46W32/x4
python calculate_PSNR_SSIM.py --folder_Gen /root/autodl-tmp/TransENet_base/experiment/results/s1_trans_f1_46W32/x4 | tail -n 1 >> results.txt
python demo_deploy.py --model CSYMUNET_PRETRAIN_S1_Trans_F2     --symunet_pretrain_width 32     --symunet_pretrain_enc_blk_nums 4,6     --symunet_pretrain_dec_blk_nums 6,4     --dataset UCMerced     --scale 4 --pre_train /root/autodl-tmp/TransENet_base/experiment/s1_trans_f2_001_s1_trans_f2_w32/model/model_best.pt --dir_out ../experiment/results/s1_trans_f2_46W32/x4
python calculate_PSNR_SSIM.py --folder_Gen /root/autodl-tmp/TransENet_base/experiment/results/s1_trans_f2_46W32/x4 | tail -n 1 >> results.txt
python demo_deploy.py --model CSYMUNET_PRETRAIN_S1_Trans_F3     --symunet_pretrain_width 32     --symunet_pretrain_enc_blk_nums 4,6     --symunet_pretrain_dec_blk_nums 6,4     --dataset UCMerced     --scale 4 --pre_train /root/autodl-tmp/TransENet_base/experiment/s1_trans_f3_001_s1_trans_f3_w32/model/model_best.pt --dir_out ../experiment/results/s1_trans_f3_46W32/x4
python calculate_PSNR_SSIM.py --folder_Gen /root/autodl-tmp/TransENet_base/experiment/results/s1_trans_f3_46W32/x4 | tail -n 1 >> results.txt
