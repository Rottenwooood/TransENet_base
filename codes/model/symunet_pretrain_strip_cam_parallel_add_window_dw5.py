...
def make_model(args, parent=False):
    return SymUNet_Pretrain_Strip_CAM_Parallel_Add_Window_DW5(args)
...
#@ARCH_REGISTRY.register("symunet_pretrain_strip_cam_parallel_add_window_dw5")
class SymUNet_Pretrain_Strip_CAM_Parallel_Add_Window_DW5(nn.Module):
    """
    symunet_pretrain_strip_cam_parallel_add_window_dw5:
    预留 window + 5x5 dwconv 分支的 strip/cam hybrid variant.
    ...
    def __init__(self, args, conv=common.default_conv):
        super(SymUNet_Pretrain_Strip_CAM_Parallel_Add_Window_DW5, self).__init__()
...
if __name__ == "__main__":
    ...
    model = SymUNet_Pretrain_Strip_CAM_Parallel_Add_Window_DW5(args)
    model.eval()
