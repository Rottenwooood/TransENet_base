...
def make_model(args, parent=False):
    return SymUNet_Pretrain_Strip_CAM_Parallel_Add_DW5_PA_LAB(args)
...
#@ARCH_REGISTRY.register("symunet_pretrain_strip_cam_parallel_add_dw5_pa_lab")
class SymUNet_Pretrain_Strip_CAM_Parallel_Add_DW5_PA_LAB(nn.Module):
    """
    symunet_pretrain_strip_cam_parallel_add_dw5_pa_lab:
    Middle Blk 使用:
    ...
    def __init__(self, args, conv=common.default_conv):
        super(SymUNet_Pretrain_Strip_CAM_Parallel_Add_DW5_PA_LAB, self).__init__()
...
if __name__ == "__main__":
    ...
    model = SymUNet_Pretrain_Strip_CAM_Parallel_Add_DW5_PA_LAB(args)
    model.eval()
