...
def make_model(args, parent=False):
    return SymUNet_Pretrain_Strip_CAM_Parallel_Add_DW5(args)
...
#@ARCH_REGISTRY.register("symunet_pretrain_strip_cam_parallel_add_dw5")
...
if __name__ == "__main__":
    ...
    model = SymUNet_Pretrain_Strip_CAM_Parallel_Add_DW5(args)
    model.eval()
