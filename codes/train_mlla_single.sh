#!/bin/bash
# Training script for symunet_pretrain_mlla_single (MLLA Linear Attention)

export http_proxy="http://127.0.0.1:7890"
export https_proxy="http://127.0.0.1:7890"

# Training
python user/batch_train.py --config user/experiments_config5_02_s1_trans_mlla_single.json

# Inference and Evaluation
python demo_deploy.py --model symunet_pretrain_mlla_single \
